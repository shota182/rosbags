...
# csv_file2 = "/home/sskr3/bags/ros1/2025-05-18-14-29-33_motor-output-position.csv"
csv_file2 = base_name + "_motor-output-position.csv"
...
# 右軸のプロット（色は任意に調整）
ax2.plot(df2_range["relative_time"].values, df2_range[col2].values, color='orange', label="encoder field.data0")
ax2.set_ylabel("Encoder Value")  # 右側のY軸ラベル
