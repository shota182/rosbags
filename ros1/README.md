...
## ```2025-07-13-00-08-57.bag```

手前のセクションでバイラテラル
ゲインうまく合わせたらできそう

## ```2025-07-13-14-02-52.bag```

4dバイラテラル．
いい感じ．
たるみなし
追従もある程度する
ただモータP制御の影響で完全に反映されない

## ```2025-07-13-14-30-48.bag```

4dバイラテラル．
発散するので確実にゲイン大きい

## ```2025-07-13-14-48-00.bag```

モータPI制御後．
4dバイラテラルのパラメータ調整．
P10.0で初期から振動．

* 2025-07-13-14-51-12.bag
P1.0でおそすぎる

* 2025-07-13-14-55-28.bag
P5.0でおかしくなった
再度挑戦

* 2025-07-13-15-12-53.bag
追従ができない(変にたるむ)
力の問題？
1と4に対して動いていない(普通にエラー)

* 2025-07-13-15-20-22.bag
結構うまくいった
フォロワ引っ張り側は位置制御だがなぜかたるんだ(これ奥のセクションの非干渉が干渉してるからでは？)

## ```2025-07-13-16-22-10.bag```

1セクションでテスト
かなりいい感じだが，フォロワ固定状態で反対に曲げようとするとたるむ

* 2025-07-13-16-32-42.bag
ゲイン少し小さい？

## ```2025-07-16-11-55-36.bag```

不感帯成功

* 2025-07-16-12-03-18.bag
不感帯成功．
動画あり

## 復元力取得のためのファイルたち

*  2025-07-21-12-03-00.bag

* 2025-07-21-12-06-31.bag

* 2025-07-21-12-17-06.bag

## バイラテラル実験用

* 2025-07-24-12-15-14.bag
こっち使う
