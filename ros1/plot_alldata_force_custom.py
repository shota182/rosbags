...
def plot_csv_data(csv_file, start_sec=0.0, end_sec=None, gradient_threshold=10.0):
    ...
    for col in df.columns:
        if (col.startswith("field.data")):
            # 平均化スライド
            df_range[col] = df_range[col].rolling(window=501, center=True).mean()

            data_raw[c] = df_range[col].to_numpy()
...
# 入力CSVファイル
input_csv = "/home/sskr3/bags/ros1/2025-07-24-12-15-14/2025-07-24-12-15-14.bag_f.csv"
